...
namespace Api.Processos.Service.Validacoes
{
    public class ProcessoValidacao : AbstractValidator<ProcessoDto>
    {
        public ProcessoValidacao()
        {
            ...
            RuleFor(x => x.Escritorio).Cascade(CascadeMode.Stop).Length(1, 50).WithMessage("O escritório tem como limite 50 caracteres");
            ...
            RuleFor(x => x.NomeReclamante).Cascade(CascadeMode.Stop).Length(1, 100).WithMessage("O nome do reclamante tem como limite 100 caracteres");
        }
